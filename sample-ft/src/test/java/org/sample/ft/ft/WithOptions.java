...
import org.sample.ft.ft.util.ProtocolEnum;
...
public final class WithOptions {
    ...
    public static void main(String[] args){
        ...
        String cucumberRepoDir=args[2];
        String jsonReportPath= StringUtils.join(new String[]{"json",cucumberRepoDir, ProtocolEnum.identify().toString(),"/result/json"});
        List<String> cucumberOptions=new ArrayList<>(Arrays.asList(OPTION_MONOCHROME,OPTION_PLUGIN,"pretty",OPTION_TAGS,tags,OPTION_PLUGIN,jsonReportPath));
