...
public final class RestUtil {
    ...
    public static ExtractableResponse<Response> executeGetRequest(final String resourcePath){
        setRestRequestConfig();
        return given().urlEncodingEnabled(false)
                .accept(ContentType.JSON)
                .headers(nullSafeMap())
                .queryParams(nullSafeMap())
                .pathParams(nullSafeMap())
                .log()
                .everything()
                .when()
                .get(resourcePath)
    ...
    private static Map<String, ?> nullSafeMap() {
        return null;
    }
